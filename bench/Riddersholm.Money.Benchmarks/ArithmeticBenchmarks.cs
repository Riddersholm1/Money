...
public class ArithmeticBenchmarks
{
    ...
    [Benchmark]
    [BenchmarkCategory("Create")]
    public NodaMoney.Money Create_NodaMoney() =>
        new(100.50m, "DKK");

    [Benchmark]
    [BenchmarkCategory("Create")]
    public Currency Create_CurrencyFromCode() =>
    ...
    [Benchmark]
    [BenchmarkCategory("Add")]
    public NodaMoney.Money Add_NodaMoney() =>
        _nodaLeft + _nodaRight;
    ...
    [Benchmark]
    [BenchmarkCategory("Subtract")]
    public NodaMoney.Money Subtract_NodaMoney() =>
        _nodaLeft - _nodaRight;
    ...
    [Benchmark]
    [BenchmarkCategory("Multiply")]
    public NodaMoney.Money Multiply_NodaMoney() =>
        _nodaLeft * 2.5m;
    ...
    [Benchmark]
    [BenchmarkCategory("Divide")]
    public NodaMoney.Money Divide_NodaMoney() =>
        _nodaLeft / 4m;
    ...
    public int ReadPrecision() =>
        Currency.DKK.DecimalDigits;
