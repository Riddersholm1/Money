...
public class FormattingBenchmarks
{
    ...
    public string Format() => _money.ToString("G", Invariant);

    [Benchmark, BenchmarkCategory("Format")]
    public string Format_NodaMoney() => _nodaMoney.ToString(Invariant);

    [Benchmark, BenchmarkCategory("Format")]
    public string Format_Localised() => _money.ToString("C", Danish);
    ...
    public Money Parse() => Money.Parse(Text, Invariant);

    [Benchmark, BenchmarkCategory("Parse")]
    public NodaMoney.Money Parse_NodaMoney() => NodaMoney.Money.Parse(Text, Invariant);

    [Benchmark, BenchmarkCategory("Parse")]
    public Money ParseSpan() => Money.Parse(Text.AsSpan(), Invariant);

    [Benchmark, BenchmarkCategory("Parse")]
    public Money ParseUtf8() => Money.Parse(Utf8Text, Invariant);

    [Benchmark, BenchmarkCategory("Parse")]
    public Currency ParseCurrency() => Currency.Parse("DKK", Invariant);
}
