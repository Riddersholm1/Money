...
{
    private static readonly JsonSerializerOptions Compact = new JsonSerializerOptions().AddMoney(MoneyJsonFormat.Compact);
    ...
    public string Serialize() =>
        JsonSerializer.Serialize(_money);
    ...
    public string SerializeCompact() =>
        JsonSerializer.Serialize(_money, Compact);

    [Benchmark]
    [BenchmarkCategory("Deserialize")]
    public Money Deserialize() =>
        JsonSerializer.Deserialize<Money>(Json);
