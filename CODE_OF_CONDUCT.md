...
Robust technical argument is welcome and expected — this project's design decisions were themselves
arrived at by argument, and [`docs/design-decisions.md`](docs/design-decisions.md) records the case
*against* each one. Disagreeing with a decision is not a conduct issue. Being unpleasant to the person
who made it is.
...
maintainers through
[GitHub's private reporting](https://github.com/Riddersholm1/Money/security/advisories/new) or by
opening a confidential issue. All complaints will be reviewed and investigated promptly and fairly.
